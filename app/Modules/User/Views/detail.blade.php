            ...
            <form class="insert_result" action="{{route('update')}}" method="post">
                ...
                <div class="insert_search">
                    ...
                    <div class="insert_search_input">
                        <input name="user_cd" type="text" id="TXT_user_cd" class="required" tabindex="4" value="{{ $m_user[0]->user_cd}}" readonly="true"> 
                ...
                <input name="user_nm_j" type="text" id="TXT_user_nm_j" class="insert_ime required" tabindex="5" value="{{ $m_user[0]->user_nm_j}}">
                <span></span>

                <label for="">ユーザー略称和文</label>
                <input name="user_ab_j" type="text" id="TXT_user_ab_j" class="insert_ime required" tabindex="6" value="{{ $m_user[0]->user_ab_j}}">
                <span></span>
                ...
                <input name="user_ab_e" type="text" id="TXT_user_ab_e" class="insert_ime-disable required" tabindex="8" value="{{ $m_user[0]->user_ab_e}}">
                <span></span>

                <label for="" >パスワード</label>
                <input name="pwd" type="password" id="TXT_pwd" class="insert_ime-disable required" min="6" tabindex="9"  value="{{ $m_user[0]->pwd}}">
                <span></span>
                ...
                <input name="login_datetime" type="text" id="TXT_login_datetime" class="" disabled value="{{$m_user[0]->login_datetime}}">
                <span></span>
    ...
    @section('content')
        <div class="insert">
            ...
            <form class="insert_result" action="{{route('insert/save')}}" method="post">
                ...
                <label for="">ユーザー名称和文</label>
                <input name="user_nm_j" type="text" id="TXT_user_nm_j" class="insert_ime required" tabindex="5" value="">
                <span></span>

                <label for="">ユーザー略称和文</label>
                <input name="user_ab_j" type="text" id="TXT_user_ab_j" class="insert_ime required"tabindex="6" value="">
                <span></span>
                ...
                <label for="">ユーザー略称英文</label>
                <input name="user_ab_e" type="text" id="TXT_user_ab_e" class="insert_ime-disable required" tabindex="8" value="">
                <span></span>

                <label for="" >パスワード</label>
                <input name="pwd" type="password" id="TXT_pwd" class="insert_ime-disable required" tabindex="9" min="6"  value="">
                <span></span>
                ...
                <label for="">役職区分</label>
                <select name="position_div" id="CMB_position_div" tabindex="11" class="required" value="">
                    @foreach( $position_divs as $user)
                ...
                <label for="">権限区分</label>
                <select name="auth_role_div" id="CMB_auth_role_div" tabindex="12" class="required" value="">
                    @foreach( $auth_role_divs as $user)
                ...
                <label for="">在職区分</label>
                <select name="incumbent_div" id="CMB_incumbent_div" tabindex="13" class="required" value="">
                    @foreach( $incumbent_divs as $user)
                ...
                <label for="" class="label-black">パスワード変更日時</label>
                <input name="pwd_upd_datetime" type="text" id="TXT_pwd_upd_datetime" disabled value="">
                <span></span>
                                    
                <label for="" class="label-black">最終ログイン日時</label>
                <input name="login_datetime" type="text" id="TXT_login_datetime" disabled value="">
                <span></span>
